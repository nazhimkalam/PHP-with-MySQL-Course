    ...
    <div class="actions">
      ...
      <?php foreach($pages as $page) { ?>
        <tr>
          ...
          <td><a class="action" href="<?php echo url_for('/staff/pages/show.php?id=' . htmlspecialchars(urldecode($page['id']))); ?>">View</a></td>
          <td><a class="action" href="<?php echo url_for('/staff/pages/edit.php?id=' . htmlspecialchars(urldecode($page['id']))); ?>">Edit</a></td>
